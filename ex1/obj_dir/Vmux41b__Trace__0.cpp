...
void Vmux41b___024root__trace_chg_sub_0(Vmux41b___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vmux41b___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux41b___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vmux41b___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vmux41b___024root__trace_chg_sub_0(Vmux41b___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux41b__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux41b___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vmux41b___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux41b___024root__trace_cleanup\n"); );
    // Init
    Vmux41b___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vmux41b___024root*>(voidSelf);
    Vmux41b__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
